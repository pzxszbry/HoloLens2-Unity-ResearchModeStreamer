#include "pch.h"
#include "HoloLens2_ResearchModeStreamerMain.h"
#include "Common/DirectXHelper.h"

#include <windows.graphics.directx.direct3d11.interop.h>

using namespace HoloLens2_ResearchModeStreamer;
...
HoloLens2_ResearchModeStreamerMain::HoloLens2_ResearchModeStreamerMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&HoloLens2_ResearchModeStreamerMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&HoloLens2_ResearchModeStreamerMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&HoloLens2_ResearchModeStreamerMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void HoloLens2_ResearchModeStreamerMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&HoloLens2_ResearchModeStreamerMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&HoloLens2_ResearchModeStreamerMain::OnCameraRemoved, this, _1, _2));
...
void HoloLens2_ResearchModeStreamerMain::UnregisterHolographicEventHandlers()
{
...
HoloLens2_ResearchModeStreamerMain::~HoloLens2_ResearchModeStreamerMain()
{
...
HolographicFrame HoloLens2_ResearchModeStreamerMain::Update(HolographicFrame const& previousFrame)
{
...
bool HoloLens2_ResearchModeStreamerMain::Render(HolographicFrame const& holographicFrame)
{
...
void HoloLens2_ResearchModeStreamerMain::SaveAppState()
{
    //
...
void HoloLens2_ResearchModeStreamerMain::LoadAppState()
{
    //
...
void HoloLens2_ResearchModeStreamerMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void HoloLens2_ResearchModeStreamerMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HoloLens2_ResearchModeStreamerMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HoloLens2_ResearchModeStreamerMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void HoloLens2_ResearchModeStreamerMain::OnCameraAdded(
...
void HoloLens2_ResearchModeStreamerMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void HoloLens2_ResearchModeStreamerMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void HoloLens2_ResearchModeStreamerMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void HoloLens2_ResearchModeStreamerMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&HoloLens2_ResearchModeStreamerMain::OnLocatabilityChanged, this, _1, _2));
