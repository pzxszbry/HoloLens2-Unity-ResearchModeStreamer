...
namespace HoloLens2_ResearchModeStreamer
{
    class HoloLens2_ResearchModeStreamerMain : public DX::IDeviceNotify
    {
    public:
        HoloLens2_ResearchModeStreamerMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~HoloLens2_ResearchModeStreamerMain();
